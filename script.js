...
//console.log("Total Months with finances.length: " + finances.length); (alternative for console.log("Total Months: " + months);)
...
console.log("Least Increase in Profits: $" + least);
    // for (let number of money) {
        //    total += money;
        //  }
        //  return total;
    ...
    //  for (let k = 0; k < money.length; k += 1) {
        // total += array[k];
         //return total;
            //console.log(money[k]);
